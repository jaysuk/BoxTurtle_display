...
// Two 50-line buffers for Double-Buffered DMA (Approx 48KB each, 96KB total)
static lv_disp_draw_buf_t draw_buf;
static lv_color_t buf1[screenWidth * 50];
static lv_color_t buf2[screenWidth * 50];
...
void setup() {
  ...
  lv_init();
  lv_disp_draw_buf_init(&draw_buf, buf1, buf2, screenWidth * 50);
